...
#wrap a prompt as a class_var and change all
...
#def attempt_line(msg) = "Alright, so based on your location, here's a pretty solid line:", 'my b on that, try this:', 'Ok, this will deff work'
#   puts ''
...
# def accept_or_pass?(msg)   = 'Did they buy it?', "If this doesn't work this person is whack."
#   answer = @prompt.select(msg, %w(fershur nawww))
#     if answer == 'nawww'
#         return false
#     else
#         puts 'TAAAAIGHT!'
              #self.accepted_lines << random_line        #that needs fixing
# end
